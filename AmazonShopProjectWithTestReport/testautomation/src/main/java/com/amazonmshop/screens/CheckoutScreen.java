...
public class CheckoutScreen extends HomeScreen {
	...
	public void verifyProductDetails(Client client, ReadProperties checkoutScreenLocators) throws Exception {
		client.waitForElement("NATIVE", checkoutScreenLocators.getElement("ProceedToBuy_button"), 0, 10000);

		// No specific locator id is available for product description and price. So,
		// tried maximum to verify description
		String description = client.elementGetText("NATIVE", checkoutScreenLocators.getElement("Product_description"), 0);
